...
textarea:focus + hr {
   ...
   <h3 style="font-weight: bold; margin-left: 7px;">공지사항 작성</h3>
   </div> 	
   <form action="/notice/register" method="post">
  	<div style="margin: auto;  height: 70px; margin-top: 20px; width: 900px;" >
  		<input type="text" class="form-control" id="title" name="title" placeholder="제목을 입력해주세요" style="width: 100%; height: 50px; position: relative; left: -24px;" required>
	</div>
   	<div style="margin: auto;  height: 370px; margin-top: 10px; width: 900px; " >
   		<textarea id="content" name="content" style="width: 100%; height: 100%;" placeholder="내용을 작성해주세요" required></textarea><hr>
   	</div>
	<div style="margin: auto;  height: 50px; margin-top: 20px; width: 900px; margin-bottom: 20px;" >
	    ...
	    <input type="text" id="writer" name="writer"  value="관리자" readonly="readonly" style="width: 26%; height:48px; position: relative; left:40px; top:-48px; float: right; margin-left: 5px; ">
	...
	<div style="width: 150px; margin: auto; padding-bottom: 12px;">
		...
		<button type="reset" class="btn btn-outline-dark"><a href="/notice/list">취소</a></button>
	</div>
   	</form>
    </div>
